...
from src.config import (
    BASELINE_SERVICES_FILE,
    EXTRACTED_TOP_LEVEL_ARCH_FILE,
    ADR_DIR,
    GUIDANCE_DIR,
    TEMPLATE_FILE,
)
...
def run(state: AgentState) -> AgentState:
    state.baseline_services = _read_json(BASELINE_SERVICES_FILE, default=[])
    state.extracted_top_level_architecture = _read_json(EXTRACTED_TOP_LEVEL_ARCH_FILE, default={})
